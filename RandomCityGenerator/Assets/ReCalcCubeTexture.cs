...
public class ReCalcCubeTexture : MonoBehaviour
{
    ...
    public void reCalcCubeTexture(GameObject meshes)
    {

        //if the scale has changed, do something...
        if (currentScale != meshes.transform.localScale)
        {

            currentScale = meshes.transform.localScale;
